...
<html>
    ...
    <body>
        ...
        <div class="container">
          <a class="navbar-brand js-scroll-trigger" href="#page-top">CONCESIONARIO-MENU VENTAS</a>
        ...
        <h1>MENU VENTAS</h1>
        <div>
            <a href="/../concesionariodb/ServletVentas?action=listar">listar</a>
            <a href="ServletVentas?action=editar">editar</a>
